...
| -------- | --------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| P1       | [#4482](https://github.com/actions/runner/pull/4482)                                                      | **Canceled background steps should not impact job result** | Full background coordinator, wait/wait-all/cancel control steps, cancellation grace period, deferred state flush, safety net, and explicit-cancel result exclusion implemented.                                                                                                                        | ✅ good                     |
...
| Background step result aggregation (v2.336.0)                   | Async coordinator with bounded concurrency, wait/wait-all/cancel control steps, linked cancellation, 7.5 s grace period, deferred outputs/environment/path/result flush, live steps expression scope, and explicit-cancel result exclusion                                                                                                                                                                                                                                              | ✅ good                                              |
...
| P1       | `BackgroundStepCoordinator` + cancel-control           | v2.336.0         | ✅ implemented with focused lifecycle, control-flow, deferral, expression-scope, and masking tests; official-runner capture remains pending               |
