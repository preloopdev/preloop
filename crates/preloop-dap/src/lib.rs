...
//! preloop-dap — Debug Adapter Protocol implementation for the aksh runner.
//!
...
#![doc(html_root_url = "https://docs.rs/preloop-dap/0.1.0")]
...
/// `use preloop_dap::*;` without listing every module.
