...
impl SessionRecord {
    ...
    fn push_event(
        &mut self,
        event: &str,
        step: Option<preloop_gha_protocol::debug_session::FailedStep>,
...
pub(crate) fn test_open_request(
    ...
    use preloop_gha_protocol::debug_session::FailedStep;
    OpenSessionRequest {
        run_id,
        job_id,
...
mod tests {
    use super::*;
    use preloop_gha_protocol::debug_session::AttemptRecord;
