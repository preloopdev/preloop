# preloop-runner — Rust GitHub Actions Runner

`preloop-runner` is a native Rust reimplementation of the client-side execution component (`Runner.Listener` + `Runner.Worker`) of the official GitHub Actions runner.
