//! Conformance harness for comparing Preloop with ChristopherHX/runner.server.
...
enum CommandKind {
    ...
    /// Run an upstream command and a Preloop command, then compare stdout exactly.
    CompareCommand {
    ...
    /// Placeholder for libkrun Runner.Listener integration tests.
    LibkrunPlan,
}
