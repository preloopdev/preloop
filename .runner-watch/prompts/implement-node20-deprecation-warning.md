...
[implementation]
approach = '''
Ensure job-level annotations from the runner are accepted and surfaced; do not synthesize warnings server-side unless preloop starts selecting action runtimes.
'''
