...
if lsof -ti:18080 &>/dev/null; then
    echo "port 18080 (mitmproxy) is already in use — stop it first or kill the process" >&2
    exit 2
fi
...
ENVEOF
    ...
    export https_proxy=http://127.0.0.1:18080 HTTPS_PROXY=http://127.0.0.1:18080
    export http_proxy=http://127.0.0.1:18080  HTTP_PROXY=http://127.0.0.1:18080
