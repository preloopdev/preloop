...
- `docs/internal/preloop-performance-engineering.md` — perf campaign record: harness, measurements, rejected ideas, and the cold-start blocker
- `docs/internal/smolvm-packed-socket-handoff.md` — fork implementation brief and upstream issue for packed-machine socket publication
