...
- official capture: `/Users/bnjoroge/runner-watcher/.runner-watch/conformance/v2.335.1/12-artifact/official-filtered`
- aksh capture: `/Users/bnjoroge/runner-watcher/.runner-watch/conformance/v2.335.1/12-artifact/aksh`
- official summary: status=captured flows=33
- aksh summary: status=captured flows=34
...
| `POST ?/twirp/github.actions.results.api.v1.ArtifactService/CreateArtifact` | 0 | 1 ⚠ |
| `POST ?/twirp/github.actions.results.api.v1.ArtifactService/FinalizeArtifact` | 0 | 1 ⚠ |
| `POST ?/twirp/github.actions.results.api.v1.ArtifactService/GetSignedArtifactURL` | 0 | 1 ⚠ |
| `POST ?/twirp/github.actions.results.api.v1.ArtifactService/ListArtifacts` | 0 | 2 ⚠ |
...
-  "POST results-receiver.actions.githubusercontent.com/twirp/github.actions.results.api.v1.ArtifactService/ListArtifacts",
-  "POST results-receiver.actions.githubusercontent.com/twirp/github.actions.results.api.v1.WorkflowStepUpdateService/WorkflowStepsUpdate",
-  "POST results-receiver.actions.githubusercontent.com/twirp/github.actions.results.api.v1.ArtifactService/GetSignedArtifactURL",
-  "POST results-receiver.actions.githubusercontent.com/twirp/results.services.receiver.Receiver/GetStepLogsSignedBlobURL",
-  "POST results-receiver.actions.githubusercontent.com/twirp/results.services.receiver.Receiver/GetStepLogsSignedBlobURL",
-  "POST results-receiver.actions.githubusercontent.com/twirp/results.services.receiver.Receiver/GetStepLogsSignedBlobURL",
-  "POST results-receiver.actions.githubusercontent.com/twirp/results.services.receiver.Receiver/GetStepLogsSignedBlobURL",
