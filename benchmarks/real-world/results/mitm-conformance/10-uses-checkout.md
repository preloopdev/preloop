...
- official capture: `/Users/bnjoroge/cachingv4/.runner-watch/golden/v2.335.1/10-uses-checkout`
- aksh capture: `/Users/bnjoroge/cachingv4/experiments/mitm/captures/aksh/10-uses-checkout/latest`
- official summary: status=ok flows=35
- aksh summary: status=None flows=44
...
| `POST results-receiver.actions.githubusercontent.com/twirp/github.actions.results.api.v1.WorkflowStepUpdateService/WorkflowStepsUpdate` | 5 | 2 ⚠ |
...
@@ -2,12 +2,12 @@
   "authorization": {
     "publicKey": {
       "exponent": "AQAB",
-      "modulus": "{token}/1NK1hnsD8TQV3d0wYmhMk2h/zpOPuWfu+iV+quyI8V4GnUFEdGyiE8S/rvd/{token}/ClsIVWGTmK1yWYR+NzCjKWWjQyBuJO7Pnd0x+{token}+{token}+PlvYi7wDLUZ8wWbh+mkovO110pG0iOQAwve72GaA/K+/A6yCbPb7Kw=="
+      "modulus": "rfKwxawANYKkSlXW/JPbzuPBrIKfZow+0kUAjG9RYbLh6JB7O/{token}+MfpK+uSLtZBx3ozINxpN3wb9/xj22oI/{token}/8oq/umpSGR7e0oWtW/{token}/hEKH4PBVu/bUnVqTpgYIOkf+3M+9Y3OzcEdWP384syJ+{token}=="
     }
   },
   "createdOn": "{time}",
-  "disableUpdate": false,
